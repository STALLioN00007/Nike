    ...
    <section id="home" className="w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container ">
      ...
      w-full max-xl:padding-x pt-28">
        ...
        font-bold">
          ...
          <br />
          <span className="text-coral-red inline-block mt-3">Nike Boost</span>  Shoes
          </h1>
          <p className="font-montserrat text-slate-gray text-lg leadng-8 mt-6 mb-14 sm:max-w-sm">Discover stylish Nike arrivals, quality comfort, and innovation for
          your active life.</p>
