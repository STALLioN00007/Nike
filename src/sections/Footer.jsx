...
const Footer = () => {
  return (
    <footer className="max-container">
      <div className="flex justify-between items-start gap-20 flex-wrap max max-lg:flex-col">
      ...
      <div className="flex justify-between text-white-400 mt-24 max-sm:items-center">
        ...
        <p className="font-montserrat cursor-pointer ml-7">  Terms & Conditions.  Website by-Bishesh</p>
